...
def checkout(request):
    user = request.user
    categories = Category.objects.all()
    products_ids_str = request.GET.get('products', '')
    products_ids = [int(id) for id in products_ids_str.split(',') if id.isdigit()]
    ...
    return render(request, 'shop/checkout.html', {
        ...
        'iamport_shop_id': 'your_actual_iamport_shop_id',  # Replace with your actual Iamport shop ID
    })
